...
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAVECROSS/Feed-Find-0.09.tar.gz
...
%prep
%setup -q -n Feed-Find-0.09
cd %{_builddir}
tar xf %{_sourcedir}/libxml-feed-perl_0.53+dfsg-1.debian.tar.xz
cd %{_builddir}/Feed-Find-0.09
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Feed-Find-0.09/deblicense/
